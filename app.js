...
function createSale(){
  ...
  // create sale
  const sale = { id: 's_'+Date.now(), date: new Date().toISOString(), product_id: p.id, name: p.name, qty, unit_price: p.price, total: p.price * qty, client:{name:client, phone:phone} };
